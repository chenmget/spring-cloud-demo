...
/**
 * 用户详情 （主要是加一些 ID  对应的名称 如lanName等等）
 * @author generator
 * @version 1.0
 * @since 1.0
 */
@Data
@ApiModel(value = "主要对应模型SYS_USER, 对应实体User类")
public class UserDetailDTO implements java.io.Serializable {
    private static final long serialVersionUID = 944673681654948880L;
...
//	private java.lang.String loginPwd;
     ...
     * 状态   1有效、 0 失效 2：其他状态
     */
    @ApiModelProperty(value = "状态   1有效、 0 失效   2其他状态")
