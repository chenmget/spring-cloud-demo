 ...
 */
@Data
@TableName("act_marketing_activity_modify")
@KeySequence(value = "seq_act_marketing_activity_modify_id", clazz = String.class)
@ApiModel(value = "对应模型act_marketing_activity_modify, MarketingActivityModify")
public class MarketingActivityModify implements Serializable{

    private static final long serialVersionUID = -4889704958612949093L;

    /**表名常量*/
    public static final String TNAME = "act_marketing_activity_modify";
...
//    private java.lang.String brief;
     ...
     * 操作类型
     */
    @ApiModelProperty(value = "操作类型 OPER_TYPE")
    private String operType;

    /**
     * 版本号
     */
    @ApiModelProperty(value = "版本号 VER_NUM")
    private Long verNum;
    ...
    public enum FieldNames {
        ...
        /** 活动类型名称. */
        activityTypeName("activityTypeName","ACTIVITY_TYPE_NAME"),

        /** 营销活动产生的优惠的类型，可为空（无优惠的活动如预售）
         优惠类型：10减免20券30返利40赠送50红包. */
        promotionType("promotionType","PROMOTION_TYPE_CODE"),
        ...
        /** 关联任务ID. */
        relatedTaskId("relatedTaskId","RELATED_TASK_ID"),
        ...
        /** 活动发布url. */
        activityUrl("activityUrl","ACTIVITY_URL"),

        /** 活动页面图片. */
        pageImgUrl("pageImgUrl","PAGE_IMG_URL"),

        /** 活动顶部图片. */
        topImgUrl("topImgUrl","TOP_IMG_URL"),

        /** 是否推荐：0否/1是. */
        isRecommend("isRecommend","IS_RECOMMEND"),

        /** 记录首次创建的员工标识。. */
        creator("createStaff","CREATOR"),
        ...
        activityScopeType("activityScopeType","ACTIVITY_SCOPE_TYPE"),

        /** 记录营销活动参与范围：10地区/20对象。  .   */
        activityParticipantType("activityParticipantType","ACTIVITY_PARTICIPANTTYPE_TYPE"),
        /** 支付方式. */
        payType("payType","PAY_TYPE"),
        /** 支付定金开始时间. */
        preStartTime("preStartTime","PRE_START_TIME"),

        /** 支付定金结束时间. */
        preEndTime("preEndTime","PRE_END_TIME"),

        /** 支付尾款开始时间. */
        tailPayStartTime("tailPayStartTime","TAIL_PAY_START_TIME"),

        /** 支付尾款结束时间. */
        tailPayEndTime("tailPayEndTime","TAIL_PAY_END_TIME"),

        /**活动预付款*/
        advancePayAmount("advancePayAmount","ADVANCE_PAY_AMOUNT"),

        /**活动参与数量*/
        participateNum	("participateNum","PARTICIPATE_NUM"),

        /**活动发货开始时间*/
        deliverStartTime("deliverStartTime","DELIVER_START_TIME"),

        /**活动发货截止时间*/
        deliverEndTime("deliverEndTime","DELIVER_END_TIME");
