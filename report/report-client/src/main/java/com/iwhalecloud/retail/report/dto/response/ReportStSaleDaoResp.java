...
public class ReportStSaleDaoResp implements Serializable {
	...
	private String partnerCode; 	//零售商编码：取PARTNER_CODE字段
	private String businessEntityName; //经营主体名称：取BUSINESS_ENTITY_NAME字段；
	...
	private String cityId; 		//地市：取CITY_ID字段获取中文
	private String countyId; 		//区县：取COUNTY_ID字段获取中文
	private String productBaseName; 	//机型：取PRODUCT_BASE_NAME字段
	private String brandName; 		//品牌：取BRAND_NAME字段
	private String priceLevel; 		//机型档位：取PRICE_LEVEL字段
	private String totalInNum; 	//入库总量：取TOTAL_IN_NUM字段求和
	...
	private String stockNum; 		//库存量：取STOCK_NUM字段
