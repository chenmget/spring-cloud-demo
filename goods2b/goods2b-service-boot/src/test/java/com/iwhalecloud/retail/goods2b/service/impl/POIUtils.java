...
import com.iwhalecloud.retail.goods2b.dto.req.ProdGoodsAddReq;
import com.iwhalecloud.retail.goods2b.entity.GoodsExt;
...
//                    }
    ...
    private static String fixPath(String url, Integer index){
    	...
    	String bUrl = "http://gz.iwhalecloud.com:6197/goods2b/";
    	switch (index) {
	        case 0:
	        	bUrl += "fznzd/"; 
	            break;
