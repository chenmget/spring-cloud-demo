...
import com.iwhalecloud.retail.web.controller.b2b.fdfs.req.FileBase64UploadReq;
...
public class FileManagerController extends BaseController {
    ...
    public ResultVO uploadImageString(@RequestBody List<FileBase64UploadReq> files) {
        ...
        try {
            ...
            ResultVO resp = fileManagerService.uploadImage(fileDtos);
        } catch (Exception e) {
    ...
    public ResultVO uploadImageByFile(@RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            resultVO = fileManagerService.uploadImage(fileManagerDTO);
        } catch (Exception e) {
            resultVO.setResultCode(ResultCodeEnum.ERROR.getCode());
            resultVO.setResultMsg(e.getMessage());
            log.error("图片流上传失败",e);
    ...
    public ResultVO deleteImg(@RequestBody FileManagerDTO fileManagerDTO) {
        ResultVO resultVO = new ResultVO();
        ResultVO resp = fileManagerService.deleteImg(fileManagerDTO);
        return resultVO;
    }
}
