 ...
 */
@Data
@ApiModel(value = "B2B编辑商品请求参数")
@JsonIgnoreProperties(ignoreUnknown = true)
public class GoodsEditReq extends AbstractRequest implements Serializable {

    private static final long serialVersionUID = -4639043180877890587L;
