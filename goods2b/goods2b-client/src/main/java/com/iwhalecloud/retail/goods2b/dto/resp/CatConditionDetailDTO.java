 ...
 */
@Data
@ApiModel(value = "分类条件 详情对象  对应模型prod_cat_condition")
public class CatConditionDetailDTO  implements java.io.Serializable {
    private static final long serialVersionUID = -5826931216266987312L;
