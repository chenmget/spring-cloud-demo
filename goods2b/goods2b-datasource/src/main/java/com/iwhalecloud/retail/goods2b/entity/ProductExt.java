 ...
 */
@Data
@TableName("prod_product_ext")
//@KeySequence(value="seq_prod_product_ext_id",clazz = String.class)
@ApiModel(value = "对应模型prod_product_ext, 对应实体ProductExt类")
public class ProductExt implements Serializable {
    /**表名常量*/
    public static final String TNAME = "prod_product_ext";
    ...
    public enum FieldNames {
		...
		/** param26. */
		param26("param26","PARAM26"),
		
		/** param27. */
		param27("param27","PARAM27"),
		
		/** param28. */
		param28("param28","PARAM28"),
		
		/** param29. */
		param29("param29","PARAM29"),
		
		/** param30. */
		param30("param30","PARAM30"),
		
		/** param31. */
		param31("param31","PARAM31"),
		
		/** param32. */
		param32("param32","PARAM32"),
		
		/** param33. */
		param33("param33","PARAM33"),
		
		/** param34. */
		param34("param34","PARAM34"),
		
		/** param35. */
		param35("param35","PARAM35"),
		
		/** param36. */
		param36("param36","PARAM36"),
		
		/** param37. */
		param37("param37","PARAM37"),
		
		/** param38. */
		param38("param38","PARAM38"),
		
		/** param39. */
		param39("param39","PARAM39"),
		
		/** param40. */
		param40("param40","PARAM40"),
		
		/** param41. */
		param41("param41","PARAM41"),
		
		/** param42. */
		param42("param42","PARAM42"),
		
		/** param43. */
		param43("param43","PARAM43"),
		
		/** param44. */
		param44("param44","PARAM44"),
		
		/** param45. */
		param45("param45","PARAM45"),
		
		/** param46. */
		param46("param46","PARAM46"),
		
		/** param47. */
		param47("param47","PARAM47"),
		
		/** param48. */
		param48("param48","PARAM48"),
		
		/** param49. */
		param49("param49","PARAM49"),
		
		/** param50. */
		param50("param50","PARAM50"),
		
		/** param51. */
		param51("param51","PARAM51"),
		
		/** param52. */
		param52("param52","PARAM52"),
		
		/** param53. */
		param53("param53","PARAM53"),
		
		/** param54. */
		param54("param54","PARAM54"),
		
		/** param55. */
		param55("param55","PARAM55"),
		
		/** param56. */
		param56("param56","PARAM56"),
		
		/** param57. */
		param57("param57","PARAM57"),
		
		/** param58. */
		param58("param58","PARAM58"),
		
		/** param59. */
		param59("param59","PARAM59"),
		
		/** param60. */
		param60("param60","PARAM60"),
		
		/** param61. */
		param61("param61","PARAM61"),
		
		/** param62. */
		param62("param62","PARAM62"),
		
		/** param63. */
		param63("param63","PARAM63"),
		
		/** param64. */
		param64("param64","PARAM64"),
		
		/** param65. */
		param65("param65","PARAM65"),
		
		/** param66. */
		param66("param66","PARAM66"),
		
		/** param67. */
		param67("param67","PARAM67"),
		
		/** param68. */
		param68("param68","PARAM68"),
		
		/** param69. */
		param69("param69","PARAM69"),
		
		/** param70. */
		param70("param70","PARAM70");
