...
@Component
@Service
public class InvoiceAuditNotPassServiceImpl implements InvoiceAuditNotPassService {
    ...
    public ResultVO run(InvokeRouteServiceRequest params) {
        ...
        String vatInvoiceStatus = ParInvoiceConst.VatInvoiceStatus.NOT_AUDITED.getCode();
