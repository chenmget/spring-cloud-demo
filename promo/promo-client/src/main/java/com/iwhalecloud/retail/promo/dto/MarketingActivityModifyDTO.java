 ...
 */
@Data
@ApiModel(value = "对应模型act_marketing_activity_modify, 对应实体MarketingActivityModify类")
public class MarketingActivityModifyDTO implements Serializable{

    private static final long serialVersionUID = -2725743814257756325L;
