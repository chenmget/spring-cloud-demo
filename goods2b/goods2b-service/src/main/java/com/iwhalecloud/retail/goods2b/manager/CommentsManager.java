...
import com.iwhalecloud.retail.goods2b.entity.Comments;
import com.iwhalecloud.retail.goods2b.mapper.CommentsMapper;
...
public class CommentsManager {
    ...
    public List<Comments> listComments(String goodsId){
        QueryWrapper queryWrapper = new QueryWrapper();
        queryWrapper.eq("object_id",goodsId);
