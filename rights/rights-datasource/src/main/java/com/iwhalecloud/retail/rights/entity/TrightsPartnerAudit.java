 ...
 */
@Data
@TableName("T_RIGHTS_PARTNER_AUDIT")
@KeySequence(value="seq_t_rights_partner_audit",clazz = String.class)
@ApiModel(value = "对应模型T_RIGHTS_PARTNER_AUDIT, 对应实体TrightsPartnerAudit类")
public class TrightsPartnerAudit implements Serializable {
    /**表名常量*/
    public static final String TNAME = "T_RIGHTS_PARTNER_AUDIT";
  	 ...
  	 */
	@TableId
	@ApiModelProperty(value = "auditId")
	...
	@ApiModelProperty(value = "gmtModify")
  	 ...
  	 * partnerState
  	 */
	@ApiModelProperty(value = "partnerState")
  	private java.lang.String partnerState;
  	
  	/**
  	 * partnerAction
  	 */
	@ApiModelProperty(value = "partnerAction")
  	private java.lang.String partnerAction;
	...
	@ApiModelProperty(value = "auditState")
  	 ...
  	 * auditStaff
  	 */
	@ApiModelProperty(value = "auditStaff")
  	private java.lang.String auditStaff;
  	
  	/**
  	 * auditMsg
  	 */
	@ApiModelProperty(value = "auditMsg")
  	private java.lang.String auditMsg;
    ...
    public enum FieldNames {
		...
		/** partnerAction. */
		partnerAction("partnerAction","PARTNER_ACTION"),
		
		/** auditState. */
		auditState("auditState","AUDIT_STATE"),
		
		/** auditStaff. */
		auditStaff("auditStaff","AUDIT_STAFF"),
		
		/** auditMsg. */
		auditMsg("auditMsg","AUDIT_MSG");
