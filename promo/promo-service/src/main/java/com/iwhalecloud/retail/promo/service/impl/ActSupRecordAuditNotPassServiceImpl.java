...
import com.iwhalecloud.retail.promo.service.ActSupRecordAuditNotPassService;
...
@Component
@Service
public class ActSupRecordAuditNotPassServiceImpl implements ActSupRecordAuditNotPassService {
    ...
    public ResultVO run(InvokeRouteServiceRequest params) {
        ...
        String status =  PromoConst.ActivitySupStatus.ACTIVITY_SUP_STATUS_ERROR.getCode();
