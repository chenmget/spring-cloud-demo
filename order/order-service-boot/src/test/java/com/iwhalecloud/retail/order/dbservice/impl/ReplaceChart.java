...
public class ReplaceChart {
	...
	static {
		...
		keyWordMappings.put("order", "goods");
		keyWordMappings.put("Order", "Goods");
    	
		//2、设置需要导出的文件夹和目标目录
    	sourceDir = "D:\\02-project\\01-ztesoft\\NewRetail\\V1.0.1\\order";  //windows下一定得“\\”格式
    	targetDir = "D:\\02-project\\01-ztesoft\\NewRetail\\V1.0.1\\goods";												 	 //windows下一定得“\\”格式
