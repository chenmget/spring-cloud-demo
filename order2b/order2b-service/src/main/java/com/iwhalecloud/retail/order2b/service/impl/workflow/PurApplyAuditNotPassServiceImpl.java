 ...
 * @description 采购申请单审核不通过服务
 */

@Slf4j
@Service
public class PurApplyAuditNotPassServiceImpl implements PurApplyAuditNotPassService, WfRunnable {
    ...
    public ResultVO run(InvokeRouteServiceRequest params) {
        log.info("PurApplyAuditNotPassServiceImpl.run params={}", JSON.toJSONString(params));
