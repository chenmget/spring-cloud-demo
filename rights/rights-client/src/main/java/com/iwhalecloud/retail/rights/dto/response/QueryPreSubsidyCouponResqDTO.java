 ...
 */
@Data
public class QueryPreSubsidyCouponResqDTO implements Serializable {

    private static final long serialVersionUID = 3600583074483248608L;
    ...
    @ApiModelProperty(value = "可混合优惠券的列表")
    private List<MktResCouponRespDTO> mktResCouponRespDTOS;
}
