package com.iwhalecloud.retail.order.aop;
...
public class ServiceLogManagerAop {
    ...
    @Around("execution(* com.iwhalecloud.retail.order.dbservice.*.*(..)) || " +
            "execution(* com.iwhalecloud.retail.order.ropservice.*.*(..))")
    ...
    @Around("execution(* com.iwhalecloud.retail.order.service.*.*(..))")
