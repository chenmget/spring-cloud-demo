...
@Data
public class RptOrderOperatingDay implements Serializable {
/**
	 * 
	 */
	...
	private String sourceFrom="pc";//订单来源
	...
	private String resNbr;//发货串码数量：关联订单项表取SHIP_NUM字段，该字段支持报表钻取，点击后展示发货串码列表，根据订单ID从订单项明细表（ORD_ORDER_ITEM_DETAIL）获取串码
	private String receiveTime;//串码出库时间
	private String couponActive;//营销活动
	private String couponType;//优惠类型
	private String couponoMoney;//优惠额度
	...
	private String businessName;//店中商所属经营主体名称：通过USER_ID关联商家表（par_merchant），取BUSINESS_ENTITY_NAME
