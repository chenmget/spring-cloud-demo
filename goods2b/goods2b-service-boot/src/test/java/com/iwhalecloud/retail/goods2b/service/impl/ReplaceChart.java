...
public class ReplaceChart {
	...
	static {
		...
		keyWordMappings.put("import org.springframework.stereotype.Service", "import com.alibaba.dubbo.config.annotation.Service");
//		keyWordMappings.put("Goods", "Goods");
    	
		//2、设置需要导出的文件夹和目标目录
    	sourceDir = "D:\\02-project\\01-ztesoft\\NewRetail\\V1.0.1\\oms\\oms-service\\src\\main\\java\\com\\iwhalecloud\\retail\\oms\\service\\impl";  //windows下一定得“\\”格式
    	targetDir = "D:\\02-project\\01-ztesoft\\NewRetail\\V1.0.1\\oms\\oms-service\\src\\main\\java\\com\\iwhalecloud\\retail\\oms\\service\\impl222";												 	 //windows下一定得“\\”格式
