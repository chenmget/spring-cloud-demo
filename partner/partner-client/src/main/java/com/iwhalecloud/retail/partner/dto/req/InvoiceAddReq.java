...
@Data
@ApiModel(value = "专票新增参数")
public class InvoiceAddReq extends AbstractRequest implements java.io.Serializable {
     ...
     * 用户地市
     */
    @ApiModelProperty(value = "当前用户所属地市")
    private String lanId;
    
    /**
     * 用户区县
     */
    @ApiModelProperty(value = "当前用户所属区县")
