...
public class WorkFlowConst {
    ...
    public enum TASK_SUB_TYPE {
        ...
        TASK_SUB_TYPE_3033("1", "3033", "地包商管理"),
        TASK_SUB_TYPE_3036("1", "3036", "管理员注册地包审批流程"),
        TASK_SUB_TYPE_3035("1", "3035", "国/省包管理3"),
        TASK_SUB_TYPE_3037("1", "3037", "管理员注册省包审批流程"),
        TASK_SUB_TYPE_3034("1", "3034", "厂商管理（自注册）"),
        TASK_SUB_TYPE_3038("1", "3038", "厂商管理（管理平台注册）"),
        TASK_SUB_TYPE_3050("1", "3050", "厂商经营权限（串码录入"),
