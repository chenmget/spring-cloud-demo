...
import com.iwhalecloud.retail.web.controller.partner.request.PartnerStaffQryByPartnerIdReq;
import com.iwhalecloud.retail.web.controller.partner.response.PartnerStaffQryByPartnerIdResp;
...
//        return ResultVO.success(partnerStaffDTO);
    ...
    public ResultVO bindingUser(@RequestBody @ApiParam(value = "PartnerStaffAddReq", required = true) StaffBindingAdminUserReq req) {
