...
import com.iwhalecloud.retail.warehouse.service.TerminalCheckActionService;
...
@Slf4j
@Service
public class TerminalCheckPassActionImpl implements TerminalCheckActionService {
    @Reference
    ...
    public ResultVO run(InvokeRouteServiceRequest params) {
        ...
        updateReq.setStatusCd(ResourceConst.MKTRESSTATE.WATI_REVIEW.getCode());
